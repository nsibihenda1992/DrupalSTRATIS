 ...
 * @endcode
 */
$settings['hash_salt'] = '7G2qSdaHyZMcTbwnHDVGotn7WOrLJD-WJhhbL9Zio96VdDz4vGZrdXuTEJTOinqUPmEZo9HZSQ';
...
if (file_exists($app_root . '/' . $site_path . '/settings.platformsh.php') && getenv('PLATFORM_RELATIONSHIPS')) {
